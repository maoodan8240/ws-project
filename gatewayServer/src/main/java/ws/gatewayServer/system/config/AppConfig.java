package ws.gatewayServer.system.config;
...
public class AppConfig {
    public static class Key {
        ...
        public static final String WS_HttpGatewayServer_tcp_server_port = "WS-HttpGatewayServer.tcp-server.port";
        public static final String WS_HttpGatewayServer_tcp_server_disconnTimeout = "WS-HttpGatewayServer.tcp-server.disconnTimeout";
        public static final String WS_HttpGatewayServer_tcp_server_offlineTimeout = "WS-HttpGatewayServer.tcp-server.offlineTimeout";
