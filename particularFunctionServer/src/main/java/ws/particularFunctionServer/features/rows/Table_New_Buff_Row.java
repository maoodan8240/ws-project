...
public class Table_New_Buff_Row extends AbstractRow {
     ...
     * int BUFF名称
     */
    private Integer bUFFNameId;
    /**
     * int BUFF描述
     */
    private Integer bUFFExplainId;
    /**
     * string BUFF特效
     */
    ...
    public void parseRow(Map<String, String> map) throws CellParseFailedException {
        ...
        bUFFNameId = CellParser.parseSimpleCell("BUFFNameId", map, Integer.class); //int
        bUFFExplainId = CellParser.parseSimpleCell("BUFFExplainId", map, Integer.class); //int
    ...
    public Integer getbUFFNameId() {
        return bUFFNameId;
    }

    public Integer getbUFFExplainId() {
