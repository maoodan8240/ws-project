var queryLvDistributionRequest = "QueryLvDistribution$Request";


function queryLvDistribution() {
    if (!checkDate()) {
        return;
    }
    var msgContent =
    ...
    sendRequest(queryLvDistributionRequest, msgContentJsonStr, queryLvDistributionReturn);
}


function queryLvDistributionReturn(argsPass) {
    var all = {};
    var keys = [];
    var newPlayerCount = argsPass["newPlayerCount"];
    var arr = argsPass["lvs"];
    for (var idx in  arr) {
        var l = arr[idx] + "";
