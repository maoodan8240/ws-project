package ws.chatServer.system.config;
...
public class AppConfig {
    public static class Key {
        ...
        public static final String WS_ChatServer_tcp_server_port = "WS-ChatServer.tcp-server.port";
        public static final String WS_ChatServer_tcp_server_disconnTimeout = "WS-ChatServer.tcp-server.disconnTimeout";
        public static final String WS_ChatServer_tcp_server_offlineTimeout = "WS-ChatServer.tcp-server.offlineTimeout";
