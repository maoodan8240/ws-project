...
public class ChatTest1 {
    ...
    public static void login() {
        ...
        b.setSecurityCode("i/ZNrlrhA+k1riUwjY0L/PQ60ZDV1pj8mpslv8tCGJscTzjPL4y+LE+O6EZnXvLfLPGm9s6IK1oi\ncqprlUT/8CfgcD/GlfFoYzaWFjnY3cjwsdN2+3cshjeyz4QAA2PVSmRXHbS97zkPNEWxIR44cYAj\nyqfDMZGNfXxlmKd/gV8=");
    ...
    public static void sendMsg2() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            b.setUseHorn(true);
            b.setContent("世界聊天测试..... bbbbbbbbbbbb >>> " + i);
            ChatClientUtils.send(b.build(), Sm_Chat.Action.RESP_SEND);
            try {
                Thread.sleep(10000l);
            } catch (InterruptedException e) {
