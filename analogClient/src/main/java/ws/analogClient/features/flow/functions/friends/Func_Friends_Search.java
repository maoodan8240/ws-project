...
public class Func_Friends_Search {
    ...
    public static void test1() {
        ...
        b1.setAction(Action.SEARCH);
        b1.setSearchCondition("zwwac22");
        Response response1 = ClientUtils.send(b1.build(), Sm_Friend.Action.RESP_SEARCH);
