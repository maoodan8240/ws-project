...
public class Func_Friends_GetDelFriend {
    ...
    public static void test1() {
        ...
        b1.setAction(Action.GET_DEL_FRIEND);
        Sm_Common_Round.Builder b = Sm_Common_Round.newBuilder();
        b.setMin(1);
        b.setMax(2);
        b1.setRound(b);
        Response response1 = ClientUtils.send(b1.build(), Sm_Friend.Action.RESP_GET_DEL_FRIEND);
