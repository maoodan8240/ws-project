...
public class Func_Friends_Add {
    ...
    public static void test1() {
        ...
        b1.setAction(Action.ADD);
        List<String> playerIdLis = new ArrayList<>();
        playerIdLis.add("5919384d784ba361a5e7a449"); // zwwac2
        b1.addAllPlayerIdLis(playerIdLis);
        Response response1 = ClientUtils.send(b1.build(), Sm_Friend.Action.RESP_ADD);
